...
package cb_heep_ctrl_reg_pkg;
  ...
  typedef struct packed {
    logic [2:0]  q;
  } cb_heep_ctrl_reg2hw_dmr_mask_reg_t;
  ...
  // Register -> HW type
  typedef struct packed {
    cb_heep_ctrl_reg2hw_safe_configuration_reg_t safe_configuration; // [43:42]
    cb_heep_ctrl_reg2hw_dmr_mask_reg_t dmr_mask; // [41:39]
  ...
  parameter logic [BlockAw-1:0] CB_HEEP_CTRL_DMR_MASK_OFFSET = 6'h 4;
  ...
  parameter logic [3:0] CB_HEEP_CTRL_PERMIT [9] = '{
    ...
    4'b 0001, // index[1] CB_HEEP_CTRL_DMR_MASK
